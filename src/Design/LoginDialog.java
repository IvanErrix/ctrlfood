...
public class LoginDialog extends JDialog {
	...
	public LoginDialog(Controller ctrl) {
		setAlwaysOnTop(true);
		setUndecorated(true);
		setSize(355, 467);
		...
		ButtonAmministratore.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				ButtonAmministratore.setIcon(new ImageIcon(LoginDialog.class.getResource("/scrimg/ButtonAmministratoreAzzurro.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				ButtonAmministratore.setIcon(new ImageIcon(LoginDialog.class.getResource("/scrimg/ButtonAmministratore.png")));
			}
		});
		ButtonAmministratore.setSelectedIcon(new ImageIcon(LoginDialog.class.getResource("/scrimg/ButtonAmministratore.png")));
		...
		ButtonClienti.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				ButtonClienti.setIcon(new ImageIcon(LoginDialog.class.getResource("/scrimg/ButtonClienteLoginAzzurro.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				ButtonClienti.setIcon(new ImageIcon(LoginDialog.class.getResource("/scrimg/ButtonClienteLogin.png")));
			}
		});
		ButtonClienti.setPressedIcon(new ImageIcon(LoginDialog.class.getResource("/scrimg/ButtonClienteLogin.png")));
		ButtonClienti.setIcon(new ImageIcon(LoginDialog.class.getResource("/scrimg/ButtonClienteLogin.png")));
		...
		LabelSfondo.setIcon(new ImageIcon(LoginDialog.class.getResource("/scrimg/SfondoLogin.png")));
